...
namespace ArtStore.Application.Common.Extensions;
...
public static class QueryableExtensions
{
    ...
    public static async Task<PaginatedData<TResult>> PaginatedDataAsync<TEntity, TResult>(
    ...
    where TEntity : class, IEntity
    {
        ...
        var baseQuery = specificationEvaluator.GetQuery(query.AsNoTracking(), spec);
